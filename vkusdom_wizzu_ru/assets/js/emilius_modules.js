...
window.EM_Module.props = {
    ...
    types: {
        limit:  124767569,  // макс. кол-вао 
        pack:   124767577,  // размер пачки,
        unit:   124767585,  // единица измерения,
        gram:   124767593   // граммовка
    },
...
(() => {
    ...
    function changeBtnAdd(cart) {
        ...
        // const positions_count = Cart.order.getItemByID(1659258425) === undefined ? cart.positions_count : cart.positions_count - 1;
