    ...
    function actionToBar() {
        ...
        for (let tabbar of $tabItems) {
            ...
            if (
                ...
                dataPath == "/collection" && (pathname.includes("/product/") || pathname.includes("/collection/"))
            ) {
...
(() => {
    ...
    const $promo = $widget.find(
        window.matchMedia('(max-width: 63.99875em)').matches ? "#headerSaleTimerMob" : "#headerSaleTimer"
    );
